...
library NectarMath {
    ...
    function lateJoinerRate(uint256 perMember, uint16 remainingCycles) internal pure returns (uint256) {
    ...
    function isAboveThreeCycleFloor(uint16 remainingCycles) internal pure returns (bool) {
